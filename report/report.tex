...
As shown in the resulting plots the controller successfully navigates a situation where it must slow down to traverse the track in a time optimal way. The controller also takes the path through the
